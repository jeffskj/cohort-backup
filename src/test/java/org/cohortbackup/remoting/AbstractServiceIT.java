...
public class AbstractServiceIT {
    ...
    //
    // public static Class[] BASE_SERVICE_INTERFACES = new Class[] { BackupService.class,
    // EncryptionService.class };

    private static Package[] BASE_PACKAGES = new Package[]{BackupService.class.getPackage(), Node.class.getPackage(),
            EncryptionService.class.getPackage(), PersistenceFactory.class.getPackage(),
            BackupItemWebService.class.getPackage(), ChecksumUtils.class.getPackage()};

    public static final String BASE_URL = "http://localhost:8080/test";

    private static final String BEANS_XML = "<beans><alternatives>"
            + "<stereotype>org.cohortbackup.testing.Mock</stereotype>" + "</alternatives>" + "</beans>";
    ...
    public static WebArchive createBaseArchive() {
        WebArchive archive = ShrinkWrap
                ...
                .addAsWebInfResource("logback-test.xml", "classes/logback-test.xml").addAsWebInfResource("web.xml")
